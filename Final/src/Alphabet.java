...
//      add(panel_username);
//      JLabel username = new JLabel("YYI");
//      username.setFont(font);
//      username.setBounds(640, 90, 180, 50);
//      add(username);
   ...
   public void paintComponent(Graphics g) {
      ...
      //panel_username background
      g2.setColor(Color.white);
      g2.fill(new Rectangle2D.Double(580, 90, 180, 50));
   ...
   public void keyTyped(KeyEvent e) {
      ...
      if (list_choice.get(rightcnt).equals(e.getKeyChar())) {
         if (rightcnt == maxCount-1) {
             ...
             double tmp = Math.round((double)rightcnt / ((double)wrongcnt + (double)rightcnt) * 10000)/100.0;
             UserAccuracy.setText("정확도: " + tmp + "%");
             ia = new IOAlph();
             ia.setScore(tmp);
